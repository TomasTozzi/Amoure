function About() {
  return (
    <section className="flex text-rojo flex-col items-center justify-center my-6 gap-4">
      ...
      <p className="text-center px-6 sm:w-[60%]">
        ...
        adaptados a lo que buscas para hacer tu celebración única. Nos
        encargamos de cada detalle: desde los mejores alojamientos y comidas
        gourmet, hasta actividades emocionantes, para que solo te preocupes por
